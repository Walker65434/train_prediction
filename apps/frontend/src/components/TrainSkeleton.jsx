    ...
    <div className="w-full max-w-7xl mx-auto space-y-6 animate-pulse">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div className="h-7 w-32 bg-slate-800/70 rounded-xl" />
            </div>
            <div className="h-10 w-64 sm:w-96 bg-slate-800 rounded-2xl" />
            <div className="flex items-center gap-3 pt-1">
              <div className="h-7 w-36 bg-slate-800/80 rounded-xl" />
              <div className="h-4 w-4 bg-slate-800 rounded-full" />
              <div className="h-7 w-40 bg-slate-800/80 rounded-xl" />
            </div>
          </div>

          <div className="h-16 w-44 bg-slate-800/80 rounded-2xl border border-slate-800 lg:self-center" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="rounded-3xl border border-slate-800 bg-slate-900/50 p-5 space-y-3"
          >
          ...
          {[1, 2, 3, 4, 5].map((row) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="space-y-2">
                  <div className="h-4 w-36 sm:w-48 bg-slate-800 rounded-lg" />
